    ...
    >
        <div className="flex items-start gap-3 ">
            {comment.profileImage ? (
                ...
                <div className="p-2 rounded-full bg-[#0fcfef]/20 text-teal-400 group-hover:bg-[#0fcfef]/30 transition-colors">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1000">
                ...
                <input
                    ...
                    className="w-full p-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:border-teal-400 focus:ring-2 focus:ring-teal-500/20 transition-all"
                    required
                />
            </div>
            ...
            <div className="space-y-2" data-aos="fade-up" data-aos-duration="1200">
                ...
                <textarea
                    ...
                    className="w-full p-4 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:border-teal-400 focus:ring-2 focus:ring-teal-500/20 transition-all resize-none min-h-[120px]"
                    required
                />
            </div>
                    ...
                    {imagePreview ? (
                        ...
                        <div className="w-full" >
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-[#0fcfef]/20 text-teal-400 hover:bg-[#0fcfef]/30 transition-all border border-dashed border-teal-400/50 hover:border-teal-400 group"
                            >
            ...
            <button
                ...
                className="relative w-full h-12 bg-gradient-to-r from-[#16c79a] to-[#0fcfef] rounded-xl font-medium text-white overflow-hidden group transition-all duration-300 hover:scale-[1.02] hover:shadow-lg active:scale-[0.98] disabled:opacity-50 disabled:hover:scale-100 disabled:cursor-not-allowed"
            >
    ...
    return (
        ...
        <div className="p-6 border-b border-white/10" data-aos="fade-down" data-aos-duration="800">
            <div className="flex items-center gap-3">
                <div className="p-2 rounded-xl bg-[#0fcfef]/20">
                    <MessageCircle className="w-6 h-6 text-teal-400" />
                </div>
                <h3 className="text-xl font-semibold text-white">
                    Comments <span className="text-teal-400">({comments.length})</span>
                </h3>
            </div>
        </div>
        ...
        <style jsx>{`
            ...
            .custom-scrollbar::-webkit-scrollbar-track {
                background: linear-gradient(135deg, #0fcfef, #16c79a);
                border-radius: 6px;
            }
