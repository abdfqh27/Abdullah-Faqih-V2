  ...
  return (
    <div className="group relative w-full">
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-lg border border-white/10 shadow-2xl transition-all duration-300 hover:shadow-cyan-500/20">
        <div className="absolute inset-0 bg-gradient-to-br from-teal-500/10 via-cyan-500/10 to-lime-500/10 opacity-50 group-hover:opacity-70 transition-opacity duration-300"></div>
        ...
        <div className="relative p-5 z-10">
          ...
          <div className="mt-4 space-y-3">
            <h3 className="text-xl font-semibold bg-gradient-to-r from-teal-300 via-cyan-300 to-lime-300 bg-clip-text text-transparent">
              {Title}
            </h3>
